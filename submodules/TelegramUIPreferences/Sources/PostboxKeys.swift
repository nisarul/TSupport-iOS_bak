...
public struct ApplicationSpecificSharedDataKeys {
    ...
    public static let supportSettings = applicationSpecificPreferencesKey(ApplicationSpecificSharedDataKeyValues.supportSettings.rawValue)
}
